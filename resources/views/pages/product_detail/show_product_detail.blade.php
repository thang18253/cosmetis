            ...
            <div class="row">
                    <div class="col-lg-4 col-md-5">
                        <ul id="imageGallery">
                            ...
                            <li data-thumb="{{asset('backEnd/images/'.$gal->gallery_img)}}" data-src="{{asset('backEnd/images/'.$gal->gallery_img)}}">
                                <img src="{{asset('backEnd/images/'.$gal->gallery_img)}}" width="100%" height="100%" alt="{{$gal->gallery_name}}">
                            </li>
                            @endforeach                                 
                        </ul>
                    </div>
                ...
                <div class="col-sm-3 product_wrap">
                    ...
                    <div class="home-product-item">
                        ...
                        <div class="product_image">
                            <img src="{{URL::to('backEnd/images/'.$result->product_img)}}" alt="">
