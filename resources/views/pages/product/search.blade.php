        ...
        <div class="container">
            ...
            <div class="row sales">
                <div class="col l-6 m-6 c-12 single_sale">
                    <div class="single_sale_imgae">
                        <img src="{{('frontEnd/images/single_sale1.jpg')}}" alt="">
                ...
                <div class="col l-6 m-6 c-12 single_sale">
                    <div class="single_sale_imgae">
                        <img src="{{('frontEnd/images/single_sale2.jpg')}}" alt="">
                        <div class="sale_overlay"></div>
            ...
            <div class="row brands">
                ...
                <ul class="col l-12 m-12 c-12 brand_list">
                    <li>
                        <img src="{{('frontEnd/images/brand1.jpg')}}" alt="">
                    </li>
                    <li>
                        <img src="{{('frontEnd/images/brand2.jpg')}}" alt="">
                    </li>
                    <li>
                        <img src="{{('frontEnd/images/brand3.jpg')}}" alt="">
                    </li>
                    <li>
                        <img src="{{('frontEnd/images/brand4.jpg')}}" alt="">
                    </li>
                    <li>
                        <img src="{{('frontEnd/images/brand5.jpg')}}" alt="">
                    </li>
                    <li>
                        <img src="{{('frontEnd/images/brand6.jpg')}}" alt="">
                    </li>
                </ul>
            </div>
        </div>
