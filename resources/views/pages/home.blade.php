            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{asset('frontEnd/images/slide_14.png')}}" class="d-block w-100" alt="...">
                    ...
                    <div class="carousel-item">
                        <img src="{{asset('frontEnd/images/slide_16.png')}}" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="col-sm-4 product_wrap">
                        <div class="home-product-item">
                            <div class="product_image">                          
                                ...
                                <img src="{{URL::to('frontEnd/images/hot.png')}}" id="hot_product" alt="">
...
<div class="container">
    <div class="row sales">
        ...
        <div class="col-md-4 single_sale">
            <div class="single_sale_imgae">
                <img src="{{asset('frontEnd/images/single_sale6.png')}}" alt="">
                <div class="sale_overlay"></div>
                <div class="sale_discount">Sale off 30%</div>
            </div>
        </div>
    ...
    <div class="row brands">
        ...
        <ul class="col l-12 m-12 c-12 brand_list">
            <li>
                <img src="{{asset('frontEnd/images/brand_logo1.jpg')}}" alt="">
            </li>
            <li>
