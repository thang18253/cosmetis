...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{asset('frontEnd/css/style.css?version=1')}}"> -->
    <link rel="stylesheet" type="text/css" href="{{asset('frontEnd/css/style.css')}}">

    <link rel="stylesheet" href="{{asset('frontEnd/css/cartHeader.css')}}">
    <link rel="stylesheet" href="{{asset('frontEnd/css/cart.css')}}">
    <link rel="stylesheet" href="{{asset('frontEnd/css/product_detail.css')}}">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <link rel="stylesheet" href="{{asset('frontEnd/css/ightslider.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('./frontEnd/css/extra.css')}}">
    <link rel="stylesheet" href="{{asset('frontEnd/css/extra2.css')}}">
    <link rel="stylesheet" href="{{asset('frontEnd/css/login.css')}}">
    <link rel="stylesheet" href="{{asset('frontEnd/css/service.css')}}">
    <link rel="stylesheet" href="{{asset('frontEnd/css/brand_detail.css')}}">
    ...
    <div class="container-fluid wrap">
        ...
        <div class="row profile_home">
            <div class="col-md-3 offset-md-1 contact">
                ...
                <img src="{{URL::to('frontEnd/images/covn.png')}}" width="20" alt="">
                <span>VN </span>
            </div>
            <?php
             ...
             ?>
              <div class="col-md-3 offset-md-5 profile">
                <div class="profile__info" >
                   <img src="{{URL::to('frontEnd/images/'.$account_img)}}" alt="">
        ...
        <div class="row header_search">
            <a href="{{URL::to('/')}}" class="image col-md-2">
                <img src="{{asset('frontEnd/images/logo_main2.png')}}" alt="">
            </a>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    <script type="text/javascript">
        ...
        //Hỏi nhỏ đó cái setime out này để ẩn cái nào
        setTimeout(() => {
