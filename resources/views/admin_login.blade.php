...
<html lang="en">
  <head>
    ...
    <!-- Custom Theme Style -->
    <link href="{{asset('/backEnd/build/css/custom.min.css?v=').time()}}" rel="stylesheet">
    <link href="{{asset('/backEnd/build/css/style.css?v=').time()}}" rel="stylesheet">
    <link href="{{asset('/backEnd/build/css/login.css?v=').time()}}" rel="stylesheet">
  ...
  <body class="login" style="overflow: hidden">
    ...
    <script src="{{asset('/backEnd/build/js/particleJS/particles.js')}}"></script>

    <script src="{{asset('/backEnd/build/js/particleJS/app.js')}}"></script>
